<!--
  TEMPLATE — This is the default task queue template from the shared `.copilot/` submodule.
  Live task queue for this repo lives at: `.github/tasks/queue.md`
  Do NOT edit this file. Edit `.github/tasks/queue.md` instead.
-->
